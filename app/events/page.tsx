    ...
    return (
        <main className="min-h-screen bg-deep-space text-white pt-24 px-6 lg:px-20 pb-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-12">
                    <Link href="/gallery" className="inline-flex items-center text-sm text-gray-400 hover:text-white mb-4 transition-colors">
                    ...
                    <p className="text-gray-400 mt-4 max-w-2xl text-xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
                    {eventList.length === 0 ? (
                        <div className="text-center py-20 bg-white/5 rounded-xl border border-white/10">
                            <h2 className="text-2xl font-bold text-gray-400">No Upcoming Events</h2>
                            ...
                            <FloatingCard key={event.id} delay={i * 0.1} className="flex flex-col md:flex-row gap-8 bg-black/40 border-white/5 hover:border-neon-cyan/50 p-0 overflow-hidden group">
                                <div className="w-full md:w-1/3 aspect-video md:aspect-auto bg-gray-900 relative overflow-hidden group border-b md:border-b-0 md:border-r border-white/5 group-hover:border-neon-cyan/50 transition-colors">
                                    ...
                                    {event.mediaUrl ? (
                                        ...
                                        <div className="w-full h-full bg-gray-800 flex items-center justify-center text-gray-600 font-mono text-2xl group-hover:scale-110 transition-transform duration-700">
                                            <ImageIcon size={48} />
                                        </div>
                                    )}
