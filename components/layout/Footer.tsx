    ...
    return (
        <footer className="border-t border-white/5 bg-[#0B0F14] pt-20 pb-10 relative z-50">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20 mb-16">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-sm text-zinc-300">
                            <p>
                                <a href="mailto:contactus@robonari.co.in" className="hover:text-cyan-400 transition-colors">
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                <Link
                                    ...
                                    className="w-10 h-10 rounded-full flex items-center justify-center border border-transparent transition-all duration-300 hover:border-pink-500 hover:shadow-[0_0_20px_rgba(236,72,153,0.6)] hover:bg-pink-500 hover:text-white text-zinc-400"
                                >
                                    <Instagram size={20} />
                                </Link>
                                <Link
                                    href="https://www.linkedin.com/company/roboaihub/posts/?feedView=all"
                                    className="w-10 h-10 rounded-full flex items-center justify-center border border-transparent transition-all duration-300 hover:border-blue-600 hover:shadow-[0_0_20px_rgba(37,99,235,0.6)] hover:bg-blue-600 hover:text-white text-zinc-400"
                                >
                ...
                <div className="border-t border-white/5 pt-8 flex justify-center items-center text-xs text-zinc-600 font-mono">
